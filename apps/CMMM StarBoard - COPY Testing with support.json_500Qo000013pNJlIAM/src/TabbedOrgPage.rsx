<Screen
  ...
  title={null}
  urlSlug={null}
  uuid="d75a2c68-fad8-46e2-9a0a-a2d492f3ffc7"
>
  <Function
    id="modelInfoTable"
    funcBody={include("../lib/modelInfoTable.js", "string")}
    runBehavior="debounced"
  />
  <Function
    id="getAllPromotionRecordByOrg"
    funcBody={include("../lib/getAllPromotionRecordByOrg.js", "string")}
    runBehavior="debounced"
  />
  <Function
    id="metaflowRunsInfo"
    funcBody={include("../lib/metaflowRunsInfo.js", "string")}
    runBehavior="debounced"
  />
  <Function
    id="ticketAndPRInfo"
    funcBody={include("../lib/ticketAndPRInfo.js", "string")}
    runBehavior="debounced"
  />
  <Function
    id="getModelHistory"
    funcBody={include("../lib/getModelHistory.js", "string")}
    runBehavior="debounced"
  />
  <Function
    id="modelDeployedInfo"
    funcBody={include("../lib/modelDeployedInfo.js", "string")}
    runBehavior="debounced"
  />
  <Function
    id="getModelDeployDates"
    funcBody={include("../lib/getModelDeployDates.js", "string")}
    runBehavior="debounced"
  />
  <State
    id="selectedModelSource"
    value={'{\n  "source": null,\n  "value": null\n}'}
  />
  <Frame
    id="$main3"
  ...
  >
    ...
    <Select
      ...
      value="{{ url.searchParams.org_name_as_key }}"
      values="{{ item }}"
    >
